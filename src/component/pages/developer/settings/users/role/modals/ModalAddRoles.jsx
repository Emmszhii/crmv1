...
const ModalAddRoles = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v1/controllers/developer/settings/users/roles/roles.php?roleId=${itemEdit.settings_roles_aid}` //update
          : "/v1/controllers/developer/settings/users/roles/roles.php", //add
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
